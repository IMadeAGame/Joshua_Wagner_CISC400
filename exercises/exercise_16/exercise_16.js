...
function main() {
  ...
  var tick = function() {
    ...
    draw(gl, n, currentAngle, viewMatrix, u_ViewMatrix, u_ModelMatrix, modelMatrix);   // Draw the triangle
...
function draw(gl, n, currentAngle, viewMatrix, u_ViewMatrix, u_ModelMatrix, modelMatrix) {
